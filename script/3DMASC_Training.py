...
for i in list_pcx:
    ...
    if not os.path.exists(workspace + "features/" + i[0:-4] + "_features.sbf"):
        pl.cc_3dmasc.compute_features(workspace, i, query0_CC, workspace + features_file)
    print("================================")
...
pl.cloudcompare.last_file(workspace + "features/*_MERGED_*.sbf.data",
...
kappa, OA, feat_import = pl.cc_3dmasc.cross_validation(model, skf, data, labels)
