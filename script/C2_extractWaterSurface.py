...
outData = pl.lastools.filter_las(C3_data,
...
query = pl.cloudcompare.open_file(CC_opt,
...
pl.cloudcompare.last_file(workspace + C2_filename[0:-4] + "_normals_C2C_DIST_*.laz",
